...
const IMPORTED_ARTICLES: Article[] = [
  ...
  { id: "NU001", title: "The Breakfast Mistake That Steals Your Energy", category: "Nutrition", minutes: 4, blooms: "1.4k", image: CAT_IMG["Nutrition"], status: "review",
    excerpt: "You ate something 'healthy' this morning — so why the crash by 11am? The answer is hiding in your very first meal." },
  { id: "NU002", title: "Are You Actually Hungry — or Just Tired?", category: "Nutrition", minutes: 4, blooms: "1.6k", image: CAT_IMG["Nutrition"], status: "review",
  ...
  { id: "NU003", title: "Why Iron Matters More Than You Think", category: "Nutrition", minutes: 4, blooms: "1.5k", image: CAT_IMG["Nutrition"], phase: "menstrual", status: "review",
  ...
  { id: "NU004", title: "What Your Body Wants Before Your Period", category: "Nutrition", minutes: 4, blooms: "1.8k", image: CAT_IMG["Nutrition"], phase: "luteal", status: "review",
  ...
  { id: "NU005", title: "Eat With Your Cycle, Not Against It", category: "Nutrition", minutes: 4, blooms: "2.3k", image: CAT_IMG["Nutrition"], status: "review",
