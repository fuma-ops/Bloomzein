...
export const EXERCISES: Record<string, Exercise> = {
  ...
  // Core
  "dead-bug": E("dead-bug", "Dead Bug", "Deep core, coordination", { audio: true, uni: true }),
  "bird-dog": E("bird-dog", "Bird Dog", "Core, back, balance", { audio: true, uni: true }),
  ...
  "bicycle-crunch": E("bicycle-crunch", "Bicycle Crunch", "Abs, obliques", { audio: true, uni: true }),
  ...
  "russian-twist": E("russian-twist", "Russian Twist", "Obliques, core", { audio: true, uni: true }),
