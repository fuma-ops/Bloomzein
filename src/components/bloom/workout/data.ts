...
const VIDEO_SLUGS = new Set<string>([
  ...
  "side-plank", "cobra-pose", "bird-dog", "dead-bug",
]);
...
export const EXERCISES: Record<string, Exercise> = {
  ...
  // Core
  "dead-bug": E("dead-bug", "Dead Bug", "Deep core, coordination", { audio: true }),
  "bird-dog": E("bird-dog", "Bird Dog", "Core, back, balance", { audio: true }),
  "pilates-hundred": E("pilates-hundred", "Pilates Hundred", "Deep core, breath control", { audio: true }),
  "leg-raises": E("leg-raises", "Leg Raises", "Lower abs", { audio: true }),
  "scissor-kicks": E("scissor-kicks", "Scissor Kicks", "Lower abs, hip flexors", { audio: true }),
  "plank-hold": E("plank-hold", "Plank Hold", "Core, shoulders", { audio: true }),
  "side-plank": E("side-plank", "Side Plank", "Obliques, core", { audio: true }),
  "crunch": E("crunch", "Crunch", "Upper abs", { audio: true }),
  "bicycle-crunch": E("bicycle-crunch", "Bicycle Crunch", "Abs, obliques", { audio: true }),
  "mountain-climbers": E("mountain-climbers", "Mountain Climbers", "Core, shoulders, cardio", { audio: true }),
  "hollow-body-hold": E("hollow-body-hold", "Hollow Body Hold", "Deep core", { audio: true }),
  "russian-twist": E("russian-twist", "Russian Twist", "Obliques, core", { audio: true }),
  "hanging-knee-raise": E("hanging-knee-raise", "Hanging Knee Raise", "Lower abs, grip", { audio: true }),
  "cobra-pose": E("cobra-pose", "Cobra Pose", "Abs (lengthen), spine", { audio: true }),
  "seated-side-bend": E("seated-side-bend", "Seated Side Bend", "Obliques, sides", { audio: true }),
  "supine-spinal-twist": E("supine-spinal-twist", "Supine Spinal Twist", "Spine, core (release)", { audio: true }),
  "diaphragmatic-breathing": E("diaphragmatic-breathing", "Diaphragmatic Breathing", "Deep core, calm", { audio: true }),
  "pelvic-floor-release": E("pelvic-floor-release", "Pelvic Floor Release", "Pelvic floor, core (rest)", { audio: true }),
  "cat-cow": E("cat-cow", "Cat-Cow", "Spine, core, back (mobility)", { audio: true }),
  "childs-pose": E("childs-pose", "Child's Pose", "Hips, back (rest)"),

  // Arms & Shoulders
  "tricep-dips": E("tricep-dips", "Tricep Dips", "Triceps, shoulders", { audio: true }),
  "lateral-raises": E("lateral-raises", "Lateral Raises", "Shoulders", { audio: true }),
  "front-raises": E("front-raises", "Front Raises", "Front shoulders", { audio: true }),
  "banded-bicep-curl": E("banded-bicep-curl", "Banded Bicep Curl", "Biceps", { audio: true }),
  "shoulder-circles": E("shoulder-circles", "Shoulder Circles", "Shoulders (mobility)", { audio: true }),
  "push-up-knees": E("push-up-knees", "Push-Up on Knees", "Chest, arms, core", { audio: true }),
  "push-up": E("push-up", "Push-Up", "Chest, arms, core", { audio: true }),
  "overhead-press": E("overhead-press", "Overhead Press", "Shoulders, arms", { audio: true }),
  "arnold-press": E("arnold-press", "Arnold Press", "Shoulders, arms", { audio: true }),
  "tricep-overhead-extension": E("tricep-overhead-extension", "Tricep Overhead Extension", "Triceps", { audio: true }),
  "hammer-curl": E("hammer-curl", "Hammer Curl", "Biceps, forearms", { audio: true }),
  "diamond-push-up": E("diamond-push-up", "Diamond Push-Up", "Triceps, chest", { audio: true }),
  "cross-body-shoulder-stretch": E("cross-body-shoulder-stretch", "Cross-Body Shoulder Stretch", "Shoulders", { audio: true }),
  "overhead-tricep-stretch": E("overhead-tricep-stretch", "Overhead Tricep Stretch", "Triceps, shoulders", { audio: true }),
  "chest-opener": E("chest-opener", "Chest Opener Stretch", "Chest, shoulders", { audio: true }),
  "doorway-stretch": E("doorway-stretch", "Doorway Stretch", "Chest, shoulders", { audio: true }),
  "neck-rolls": E("neck-rolls", "Neck Rolls", "Neck (release)", { audio: true }),
  "shoulder-rolls": E("shoulder-rolls", "Shoulder Rolls", "Shoulders (release)", { audio: true }),
  "wrist-circles": E("wrist-circles", "Wrist Circles", "Wrists, forearms", { audio: true }),
  "gentle-arm-swings": E("gentle-arm-swings", "Gentle Arm Swings", "Arms, shoulders (mobility)", { audio: true }),

  // Back
  "superman-hold": E("superman-hold", "Superman Hold", "Lower back, glutes", { audio: true }),
  "reverse-snow-angel": E("reverse-snow-angel", "Reverse Snow Angel", "Upper back, shoulders", { audio: true }),
  "banded-row": E("banded-row", "Banded Row", "Mid back, lats", { audio: true }),
  "wall-angels": E("wall-angels", "Wall Angels", "Upper back, posture", { audio: true }),
  "back-extension": E("back-extension", "Back Extension", "Lower back", { audio: true }),
  "bent-over-row": E("bent-over-row", "Bent-Over Row", "Back, biceps", { audio: true }),
  "deadlift": E("deadlift", "Deadlift", "Back, glutes, hamstrings", { audio: true }),
  "lat-pulldown-band": E("lat-pulldown-band", "Banded Lat Pulldown", "Lats, back", { audio: true }),
  "pull-up": E("pull-up", "Pull-Up", "Back, biceps", { audio: true }),
  "renegade-row": E("renegade-row", "Renegade Row", "Back, core, arms", { audio: true }),
  "thread-the-needle": E("thread-the-needle", "Thread the Needle", "Upper back, shoulders (release)", { audio: true }),
  "seated-forward-fold": E("seated-forward-fold", "Seated Forward Fold", "Back, hamstrings (release)", { audio: true }),
  "thoracic-rotation": E("thoracic-rotation", "Thoracic Rotation", "Upper back, spine", { audio: true }),
  "foam-roll-thoracic": E("foam-roll-thoracic", "Foam Roll: Upper Back", "Upper back (release)", { audio: true }),
  "supported-fish-pose": E("supported-fish-pose", "Supported Fish Pose", "Chest, upper back (rest)", { audio: true }),

  // Legs & Thighs
  "inner-thigh-squeeze": E("inner-thigh-squeeze", "Inner Thigh Squeeze", "Inner thighs", { audio: true }),
  "curtsy-lunge": E("curtsy-lunge", "Curtsy Lunge", "Glutes, inner thighs", { audio: true }),
  "side-lunge": E("side-lunge", "Side Lunge", "Inner thighs, quads", { audio: true }),
  ...
  "seated-hamstring-stretch": E("seated-hamstring-stretch", "Seated Hamstring Stretch", "Hamstrings", { audio: true }),
  "lizard-lunge": E("lizard-lunge", "Lizard Lunge", "Hip flexors, inner thighs", { audio: true }),
  "it-band-stretch": E("it-band-stretch", "IT Band Stretch", "Outer thigh, hips", { audio: true }),
  "legs-up-wall": E("legs-up-wall", "Legs-Up-the-Wall", "Legs, circulation (rest)", { audio: true }),
  "gentle-calf-raises": E("gentle-calf-raises", "Gentle Calf Raises", "Calves", { audio: true }),
  "reclined-hamstring-stretch": E("reclined-hamstring-stretch", "Reclined Hamstring Stretch", "Hamstrings (release)", { audio: true }),
