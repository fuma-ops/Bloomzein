...
const RAW_RECIPES: RawRecipe[] = [
  ...
  },
  {
    ...
    steps: ["Brown chicken thighs with onion.", "Add apricots, cinnamon and a splash of water, cover and simmer 35 minutes.", "Top with toasted almonds before serving."],
  },
  {
  ...
  // ───────── Batch 4 — Soups (+15) ─────────
  {
    ...
    steps: ["Sauté onion and garlic until soft.", "Add tomatoes and broth, simmer 15 min.", "Blend smooth, stir in cream and fresh basil."],
  },
  {
    ...
    steps: ["Roast squash, onion and garlic until caramelised.", "Blend with broth until smooth.", "Stir in coconut milk and nutmeg, season well."],
  },
  {
    ...
    steps: ["Sauté carrots and zucchini 5 min.", "Add beans, tomatoes and broth, simmer 15 min.", "Add pasta and cook until al dente, finish with basil."],
  },
  {
  ...
  },
  {
    ...
    ingredients: [
      { name: "Cannellini beans", quantity: "1.5 cups" },
    ...
    steps: ["Sauté garlic in olive oil.", "Add beans, tomatoes, broth and rosemary, simmer 15 min.", "Stir in kale until wilted, season and serve."],
  },
  {
    ...
    ingredients: [
      ...
      { name: "Fresh herbs (parsley, cilantro)", quantity: "to taste" },
    ],
    steps: ["Sauté onion with spices until fragrant.", "Add chickpeas, lentils, tomatoes and 4 cups water, simmer 25 min.", "Finish with lemon juice and fresh herbs."],
  },
  {
    ...
    steps: ["Sauté onion, garlic and carrot until soft.", "Add lentils, broth and cumin, simmer 20 min.", "Stir in spinach until wilted, season and serve."],
  },
  {
    ...
    steps: ["Warm broth and whisk in miso paste.", "Cook noodles separately.", "Arrange noodles in broth, top with mushrooms, bok choy, halved egg and nori."],
  },
  {
    ...
    steps: ["Roast pumpkin and garlic until golden.", "Blend with broth until smooth.", "Stir in coconut cream and ginger, top with pumpkin seeds."],
  },
  {
  ...
  },
  {
    ...
    steps: ["Sauté onion and garlic with spices.", "Add beans and broth, simmer 15 min.", "Partially blend for a creamy texture, finish with lime juice."],
  },
  {
    ...
    steps: ["Sauté onion, add carrots, ginger and broth.", "Simmer until carrots are very soft.", "Blend smooth, stir in coconut milk and orange juice."],
  },
  {
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: "Onion", quantity: "1" },
      { name: "Garlic", quantity: "2 cloves" },
      { name: "Bay leaf & thyme", quantity: "1 each" },
      { name: "Vegetable broth", quantity: "4 cups" },
    ],
    steps: ["Sauté onion, garlic, carrot and celery.", "Add lentils, broth and herbs, simmer 30 min.", "Remove bay leaf, adjust seasoning and serve."],
  },
  {
    ...
    ingredients: [
      { name: "Broccoli", quantity: "400g, florets" },
      { name: "Almond milk", quantity: "1 cup" },
      { name: "Onion", quantity: "1" },
      { name: "Garlic", quantity: "2 cloves" },
      { name: "Vegetable broth", quantity: "2 cups" },
    ...
    steps: ["Sauté onion and garlic, add broccoli and broth.", "Simmer until tender, blend with almond milk and nutritional yeast.", "Top with toasted almonds to serve."],
  },
  ...
  // ───────── Batch 4 — Salads (+15) ─────────
  {
    ...
    steps: ["Roast chickpeas with oil and paprika 20 min until crispy.", "Massage kale with a little olive oil to soften.", "Blend tahini, lemon, garlic and nutritional yeast into dressing, toss with kale and top with chickpeas."],
  },
  {
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: "Red onion & cilantro", quantity: "1/4 cup each" },
      { name: "Shredded cabbage", quantity: "1 cup" },
      { name: "Lime", quantity: "1" },
      { name: "Chipotle sauce", quantity: "1 tbsp" },
    ],
    steps: ["Season and pan-fry shrimp 2-3 min each side.", "Make mango salsa: combine mango, onion, cilantro and lime.", "Fill warm tortillas with cabbage slaw, shrimp and mango salsa."],
  },
  {
    ...
    ingredients: [
      { name: "Cauliflower", quantity: "1 head, florets" },
      { name: "Coconut milk", quantity: "1 cup" },
      { name: "Crushed tomatoes", quantity: "1 cup" },
      { name: "Tikka masala paste", quantity: "2 tbsp" },
      { name: "Onion, garlic & ginger", quantity: "1 / 2 cloves / 1 tbsp" },
      { name: "Brown rice", quantity: "1 cup, cooked" },
    ],
    steps: ["Brown onion with paste, garlic and ginger.", "Add cauliflower, tomatoes and coconut milk, simmer 20 min until tender.", "Serve over brown rice."],
  },
  {
    ...
    steps: ["Brush salmon with teriyaki sauce.", "Bake 15 min at 200°C alongside broccoli drizzled with oil.", "Serve over rice, scatter sesame seeds."],
  },
  {
    ...
    steps: ["Coat chicken in pesto, bake 20 min at 190°C.", "Add cherry tomatoes alongside for last 10 min.", "Top with mozzarella and serve with roasted zucchini."],
  },
  {
    ...
    ingredients: [
      { name: "Lamb chops", quantity: "2 (200g)" },
      { name: "Bulgur wheat", quantity: "1/2 cup, cooked" },
      { name: "Flat-leaf parsley", quantity: "1 cup" },
      { name: "Tomato & cucumber", quantity: "1 each" },
      { name: "Lemon juice", quantity: "2 tbsp" },
      { name: "Olive oil", quantity: "2 tbsp" },
    ],
    steps: ["Grill lamb chops with garlic and herbs 4-5 min each side.", "Make tabbouleh: combine bulgur, parsley, tomato, cucumber, lemon and oil.", "Serve lamb alongside fresh tabbouleh."],
  },
  {
    ...
    ingredients: [
      ...
      { name: "Cream", quantity: "2 tbsp" },
      { name: "Garam masala, garlic & ginger", quantity: "1 tsp / 1 tbsp" },
    ],
    steps: ["Simmer lentils and beans in fresh water until very tender, about 30 min.", "Add spiced tomato base with butter, simmer 10 min.", "Finish with cream, serve with naan or rice."],
  },
  {
    ...
    ingredients: [
      ...
      { name: "Onion", quantity: "1" },
      { name: "Jasmine rice", quantity: "1 cup, cooked" },
      { name: "Lime & cilantro", quantity: "to serve" },
    ],
    steps: ["Sauté onion with curry paste.", "Add coconut milk and pepper, simmer 10 min.", "Add prawns, cook until pink, serve over rice with lime."],
  },
  {
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: "Onion", quantity: "1" },
      { name: "Ras el hanout", quantity: "1 tbsp" },
      { name: "Preserved lemon", quantity: "1 tbsp" },
      { name: "Vegetable broth", quantity: "1 cup" },
    ],
    steps: ["Brown chicken in pot with a little oil.", "Add onion and spices, cook 2 min.", "Add chickpeas, tomatoes, preserved lemon and broth, simmer 25 min covered."],
  },
  {
