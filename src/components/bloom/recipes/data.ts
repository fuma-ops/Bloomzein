...
const RAW_RECIPES: RawRecipe[] = [
  ...
  { id: "rainbow-buddha", name: "Rainbow Salmon Buddha Bowl", cuisine: "Asian", mealType: "lunch", prepTime: 10, cookTime: 15, difficulty: "easy", servings: 1, equipment: ["Baking tray", "Small pot"], phases: ["ovulatory", "follicular"], goal: ["maintain", "gain"], dietTags: ["gluten-free"], allergens: ["soy"], macros: { calories: 650, protein: 41, carbs: 60, fat: 26 }, micros: { omega3: 1.8, iron: 2, vitaminC: 20 }, ingredients: [ { name: "Salmon fillet", quantity: "150 g" }, { name: "Quinoa", quantity: "1/2 cup dry" }, { name: "Avocado", quantity: "1/2" }, { name: "Cooked beetroot", quantity: "1/2 cup, sliced" }, { name: "Baby spinach", quantity: "1 cup" }, { name: "Red cabbage", quantity: "1/2 cup, shredded" }, { name: "Carrot", quantity: "1/2, julienned" }, { name: "Cucumber", quantity: "1/2, sliced" }, { name: "Edamame", quantity: "1/2 cup, shelled" }, { name: "Mango", quantity: "1/4 cup, diced" }, { name: "Olive oil", quantity: "1 tbsp" }, { name: "Lemon", quantity: "1/2" }, { name: "Spring onion & sesame seeds", quantity: "to garnish" } ], steps: [ "Rinse the **quinoa** and simmer in 1 cup water for 12-15 min, then fluff with a fork.", "Rub the **salmon** with **olive oil**, **lemon** and salt, then bake at 200°C for 12 min until it flakes.", "Bowl up the quinoa and salmon, then arrange the **beetroot**, **baby spinach**, **red cabbage**, **carrot**, **cucumber**, **edamame**, **mango** and sliced **avocado** around it. Dress with a [[vinaigrette]] of olive oil and lemon and finish with **spring onion** and **sesame seeds**." ], batchTip: "Cook a big batch of quinoa for the week - it keeps 4 days chilled.", substitutionTip: "Swap salmon for roasted chickpeas to make it fully vegan." },
  {
  ...
  // ───────── Batch 2 — Lunch (+6) ─────────
  { id: "l13", name: "Vegan Buddha Bowl with Tempeh", cuisine: "Asian", mealType: "lunch", prepTime: 15, cookTime: 15, difficulty: "easy", servings: 2, equipment: ["Non-stick pan", "Steamer"], phases: ["ovulatory", "follicular"], goal: ["lose", "gain"], dietTags: ["vegan", "gluten-free"], allergens: ["soy"], macros: { calories: 745, protein: 35, carbs: 77, fat: 35 }, micros: { iron: 4, fibre: 11, vitaminC: 20 }, ingredients: [ { name: "Tempeh", quantity: "150 g, cubed" }, { name: "Brown rice", quantity: "1 cup, cooked" }, { name: "Roasted chickpeas", quantity: "3/4 cup" }, { name: "Broccoli", quantity: "1 cup, florets" }, { name: "Kale", quantity: "1 cup" }, { name: "Red cabbage", quantity: "1 cup, shredded" }, { name: "Carrots", quantity: "1/2 cup, ribboned" }, { name: "Cucumber", quantity: "1, sliced" }, { name: "Avocado", quantity: "1, sliced" }, { name: "Pumpkin seeds", quantity: "2 tbsp" }, { name: "Soy sauce", quantity: "1 tbsp" }, { name: "Sesame dressing", quantity: "2 tbsp - tap in steps to make it" }, { name: "Sesame seeds", quantity: "to garnish" } ], steps: [ "Cube the **tempeh** and pan-fry in a little oil with a splash of **soy sauce** until golden on all sides, 6-8 min.", "Steam the **broccoli**, **kale** and **carrots** for 3-4 min so they stay bright and crisp.", "Divide the **brown rice** between bowls, add the tempeh, **roasted chickpeas**, the steamed veg, **red cabbage**, **cucumber**, sliced **avocado** and **pumpkin seeds**, drizzle with [[sesame dressing]] and scatter over **sesame seeds**." ], batchTip: "Fry a double batch of tempeh - it crisps up again in a hot pan for tomorrow's bowl.", substitutionTip: "Not keen on tempeh? Firm tofu or edamame gives the same plant protein." },
  ...
  // ───────── Batch 3 — Lunch (+6) ─────────
  {
    ...
    macros: { calories: 730, protein: 22, carbs: 84, fat: 34 },
    ...
    steps: [
      ...
      "Spoon **quinoa** and **rocket** into bowls, add the warm falafel, a dollop of **hummus**, **cucumber & cherry tomatoes**, **red cabbage**, sliced **avocado**, **roasted chickpeas** and **pickled red onion**, then drizzle generously with [[tahini sauce]]."
    ],
  ...
  },
  {
    ...
    dietTags: ["vegan", "gluten-free"], allergens: ["soy"],
    servings: 1,
    equipment: ["Small pan", "Frying pan"],
    macros: { calories: 630, protein: 33, carbs: 76, fat: 24 },
    micros: { iron: 5, fibre: 16, magnesium: 60 },
    ingredients: [
      { name: "Black beans", quantity: "1 cup, drained" },
      { name: "Ground cumin", quantity: "1/2 tsp" },
      { name: "Firm tofu", quantity: "100g, for scramble" },
      { name: "Turmeric", quantity: "1/4 tsp" },
      { name: "Sweet potato", quantity: "1/2 cup, diced" },
      { name: "Cherry tomatoes", quantity: "5, halved" },
    ...
    steps: [
      "Roast or pan-fry the diced **sweet potato** until tender and caramelised, about 12 min.",
      ...
      "Crumble the **firm tofu** and fry with **turmeric** and a pinch of salt for 4-5 min into a soft golden scramble.",
      "Char the **corn tortilla** directly over the flame or in a dry pan until blistered.",
      "Build the bowl: beans, tofu scramble, sweet potato, sliced **avocado** and **cherry tomatoes**, a dollop of **coconut yoghurt** and [[salsa]]. Finish with **fresh coriander**, a squeeze of **lime** and the tortilla alongside.",
    ],
    batchTip: "Cook a big pot of spiced beans and a tray of sweet potato - the bowl then assembles in minutes.",
    substitutionTip: "Not vegan? Swap the tofu scramble for 2 scrambled eggs and use plain yoghurt or soured cream.",
  },
  {
  ...
  },
  {
    ...
    servings: 1,
    equipment: ["Blender"],
    macros: { calories: 405, protein: 8, carbs: 67, fat: 14 },
    ...
    steps: [
      ...
      "Line up **granola**, **fresh berries**, sliced **banana** and **shredded coconut** in stripes, sprinkle with **chia seeds**, and serve at once before it melts.",
    ],
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: "Fresh basil", quantity: "few leaves" },
    ],
    steps: [
      ...
      "Fold [[pesto]] through the warm eggs, pile onto the toast and finish with grated **parmesan** and a few **fresh basil** leaves.",
    ],
  ...
  },
  {
    ...
    servings: 1,
    equipment: ["Small pot"],
    macros: { calories: 390, protein: 9, carbs: 53, fat: 17 },
    ...
    steps: [
      ...
      "Top with sliced **banana**, **walnuts**, **blueberries**, **coconut flakes**, a sprinkle of **chia seeds** and a little extra black pepper.",
    ],
  ...
  },
  {
    ...
    servings: 1,
    equipment: [],
    macros: { calories: 530, protein: 16, carbs: 75, fat: 20 },
    ...
    steps: [
      ...
      "Top with **mango**, sliced **banana** and **kiwi**, and a dollop of **coconut yoghurt**.",
      "Scatter over **pumpkin seeds**, **flaked almonds**, **chia seeds** and toasted **coconut flakes**.",
    ],
