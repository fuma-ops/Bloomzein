...
const SCATTER = [
  // small daisies
  { k:"d", t:8,  l:22, sz:22, rot:20,  op:0.18, dur:22, del:-3,  c:SC[0] },
  { k:"d", t:19, l:70, sz:18, rot:-10, op:0.16, dur:26, del:-8,  c:SC[5] },
  { k:"d", t:30, l:45, sz:24, rot:35,  op:0.17, dur:20, del:-14, c:SC[1] },
  { k:"d", t:42, l:60, sz:20, rot:-25, op:0.18, dur:24, del:-5,  c:SC[2] },
  { k:"d", t:55, l:32, sz:26, rot:15,  op:0.16, dur:22, del:-11, c:SC[0] },
  { k:"d", t:66, l:78, sz:22, rot:-40, op:0.17, dur:28, del:-2,  c:SC[5] },
  { k:"d", t:78, l:18, sz:20, rot:30,  op:0.18, dur:21, del:-17, c:SC[1] },
  { k:"d", t:88, l:55, sz:24, rot:-12, op:0.16, dur:25, del:-9,  c:SC[3] },
  { k:"d", t:96, l:40, sz:18, rot:22,  op:0.17, dur:23, del:-6,  c:SC[0] },
  // hearts
  { k:"h", t:5,  l:40, sz:14, rot:8,   op:0.28, dur:16, del:-2,  c:SC[3] },
  { k:"h", t:14, l:58, sz:10, rot:-12, op:0.25, dur:18, del:-7,  c:SC[1] },
  { k:"h", t:25, l:28, sz:16, rot:5,   op:0.30, dur:14, del:-4,  c:SC[2] },
  { k:"h", t:37, l:74, sz:12, rot:-8,  op:0.26, dur:17, del:-12, c:SC[0] },
  { k:"h", t:48, l:50, sz:18, rot:15,  op:0.23, dur:15, del:-3,  c:SC[3] },
  { k:"h", t:60, l:22, sz:11, rot:-5,  op:0.28, dur:19, del:-9,  c:SC[4] },
  { k:"h", t:72, l:65, sz:15, rot:20,  op:0.25, dur:16, del:-6,  c:SC[1] },
  { k:"h", t:81, l:38, sz:13, rot:-18, op:0.30, dur:18, del:-14, c:SC[2] },
  { k:"h", t:92, l:80, sz:17, rot:7,   op:0.24, dur:15, del:-1,  c:SC[3] },
  { k:"h", t:10, l:72, sz:9,  rot:-22, op:0.21, dur:19, del:0,   c:SC[5] },
  // dots
  { k:"o", t:4,  l:34, sz:7, rot:0, op:0.32, dur:12, del:-3,  c:SC[2] },
  { k:"o", t:16, l:62, sz:5, rot:0, op:0.36, dur:14, del:-8,  c:SC[1] },
  { k:"o", t:28, l:48, sz:8, rot:0, op:0.30, dur:11, del:-1,  c:SC[3] },
  { k:"o", t:40, l:20, sz:6, rot:0, op:0.34, dur:13, del:-6,  c:SC[0] },
  { k:"o", t:52, l:76, sz:5, rot:0, op:0.27, dur:15, del:-4,  c:SC[4] },
  { k:"o", t:64, l:42, sz:9, rot:0, op:0.31, dur:12, del:-10, c:SC[2] },
  { k:"o", t:74, l:30, sz:6, rot:0, op:0.29, dur:14, del:-2,  c:SC[1] },
  { k:"o", t:85, l:68, sz:7, rot:0, op:0.35, dur:11, del:-7,  c:SC[3] },
  { k:"o", t:95, l:55, sz:5, rot:0, op:0.28, dur:13, del:-5,  c:SC[0] },
] as const;
...
export function KawaiiBackground({ className = "" }: Props) {
  return (
    ...
    >
      ...
      <span className="bz-f" style={{
        position:"absolute", top:"55%", left:"-10%", opacity:0.22,
        "--bz-r":"12deg","--bz-d":"32s","--bz-del":"-18s",
      } as React.CSSProperties}>
        <BigFlower size={380} color="oklch(0.72 0.23 350)" sw={2} />
      </span>

      {/* ── BIG OUTLINE FLOWERS — right edge ────────────────────────────── */}
      <span className="bz-f" style={{
        position:"absolute", top:"10%", left:"83%", opacity:0.26,
        "--bz-r":"18deg","--bz-d":"30s","--bz-del":"-11s",
      } as React.CSSProperties}>
        <BigFlower size={400} color="oklch(0.78 0.18 350)" sw={2} />
      </span>
      <span className="bz-f" style={{
        position:"absolute", top:"68%", left:"86%", opacity:0.22,
        "--bz-r":"-22deg","--bz-d":"26s","--bz-del":"-22s",
      } as React.CSSProperties}>
        <BigFlower size={360} color="oklch(0.74 0.21 350)" sw={2} />
      </span>

      {/* ── WIDE RAINBOW ARCS ───────────────────────────────────────────── */}
      <span className="bz-p" style={{
        position:"absolute", top:"30%", left:0, width:"100%", opacity:0.16,
        "--bz-r":"0deg","--bz-d":"38s","--bz-del":"-8s",
      } as React.CSSProperties}>
        <WideArc />
      </span>
      <span className="bz-p" style={{
        position:"absolute", top:"68%", left:0, width:"100%", opacity:0.14,
