...
// Glassmorphism bottom sheet: rises from the bottom over a blurred view of
// the page behind it, with a spring overshoot and a drag handle up top.
function OnboardingSheet({ children }: { children: React.ReactNode }) {
  return (
    <div className="fixed inset-0 z-[100] animate-fade-in">
      ...
      <div className="absolute inset-x-0 bottom-0 mx-auto flex h-[85vh] w-full max-w-sm flex-col overflow-hidden rounded-t-[2rem] border-t border-white/60 bg-white/75 shadow-2xl shadow-[#EC4899]/30 backdrop-blur-xl animate-bloom-sheet-rise">
        ...
        <div className="flex shrink-0 justify-center pt-3 pb-1">
          <div className="h-1.5 w-10 rounded-full bg-[#EC4899]/25" />
        </div>
