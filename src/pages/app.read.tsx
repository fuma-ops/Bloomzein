  ...
  return (
    <div className="relative isolate animate-fade-in">
      ...
      >
        ...
        <img src={IMG.featured} alt="" className="animate-hero-breathe h-full w-full object-cover object-[72%_48%] sm:object-[60%_42%]" referrerPolicy="no-referrer" />
      ...
      <div className="relative z-[2] mt-14 sm:mt-3 mx-auto max-w-3xl rounded-[1.75rem] border border-white/60 bg-white/50 backdrop-blur-xl p-2.5 sm:p-3.5 shadow-[0_22px_55px_-26px_oklch(0.55_0.2_350/0.55)] animate-card-pop-in">
