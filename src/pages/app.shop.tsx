...
const CATEGORIES: { key: Exclude<CatKey, "all">; label: string; img: string }[] = [
  { key: "selfcare",    label: "Self-care",   img: img("shop-cat-selfcare.jpg") },
  { key: "beauty",      label: "Beauty",      img: img("shop-cat-beauty.jpg") },
  { key: "cycle",       label: "Cycle Care",  img: img("shop-cat-cycle.jpg") },
  { key: "active",      label: "Activewear",  img: img("shop-cat-active.jpg") },
  { key: "accessories", label: "Accessories", img: img("shop-cat-accessories.jpg") },
  { key: "premium",     label: "Bloom Premium", img: img("shop-cat-premium.jpg") },
];
...
const PRODUCTS: Product[] = [
  { id: "candle",   name: "Rose Glow Candle",    price: 28,  rating: 4.9, cat: "selfcare",    img: img("shop-p-candle.jpg"),   bestseller: true },
  { id: "mask",     name: "Silk Sleep Mask",     price: 22,  rating: 4.8, cat: "selfcare",    img: img("shop-p-mask.jpg") },
  { id: "gloss",    name: "Pillow Lip Gloss",    price: 18,  rating: 4.7, cat: "beauty",      img: img("shop-p-gloss.jpg"),    bestseller: true },
  { id: "serum",    name: "Rose Petal Serum",    price: 42,  rating: 4.9, cat: "beauty",      img: img("shop-p-serum.jpg") },
  { id: "heat",     name: "Cozy Heat Wrap",      price: 36,  rating: 4.8, cat: "cycle",       img: img("shop-p-heat.jpg"),     bestseller: true },
  { id: "bottle",   name: "Bloom Water Bottle",  price: 24,  rating: 4.6, cat: "active",      img: img("shop-p-bottle.jpg") },
  { id: "leggings", name: "Soft Glow Leggings",  price: 58,  rating: 4.9, cat: "active",      img: img("shop-p-leggings.jpg"), bestseller: true },
  { id: "clip",     name: "Pearl Hair Clip",     price: 14,  rating: 4.5, cat: "accessories", img: img("shop-p-clip.jpg") },
  { id: "planner",  name: "Bloom Daily Planner", price: 32,  rating: 5.0, cat: "premium",     img: img("shop-p-planner.jpg"),  bestseller: true },
];
    ...
    <div className="relative">
      ...
      <section className="mt-6 sm:mt-8 stagger" style={{ animationDelay: "160ms" }}>
        <div className="relative overflow-hidden rounded-[1.75rem] sm:rounded-[2.5rem] border border-petal/60 shadow-[0_20px_50px_-20px_oklch(0.6_0.27_350/0.45)]">
          <img src={img("shop-hero.png")} alt="" className="absolute inset-0 h-full w-full object-cover" referrerPolicy="no-referrer" />
