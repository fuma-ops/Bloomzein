...
export const POSES: Pose[] = [
  P({ slug: "easy-seat", name: "Easy Seat", sanskrit: "Sukhasana", group: "Breathing", level: "Beginner", image: img("pose-easy-seat.png"), floorOnly: true,
    cues: {
  ...
  P({ slug: "cat-cow", name: "Cat-Cow", group: "Warm-up", level: "Beginner", image: img("pose-cat-cow.png"), floorOnly: true,
    cues: {
  ...
  P({ slug: "childs-pose", name: "Child's Pose", sanskrit: "Balasana", group: "Warm-up", level: "Beginner", image: img("pose-childs-pose.png"), floorOnly: true,
    cues: {
  ...
  P({ slug: "seated-twist", name: "Seated Twist", group: "Warm-up", level: "Beginner", image: img("pose-seated-twist.png"), floorOnly: true,
    cues: {
  ...
  P({ slug: "low-lunge", name: "Low Lunge", sanskrit: "Anjaneyasana", group: "Hips", level: "Beginner", image: img("pose-low-lunge.png"),
    cues: {
  ...
  P({ slug: "butterfly", name: "Butterfly", sanskrit: "Baddha Konasana", group: "Hips", level: "Beginner", image: img("pose-butterfly.png"), floorOnly: true,
    cues: {
  ...
  P({ slug: "pigeon", name: "Pigeon Pose", group: "Hips", level: "Intermediate", image: img("pose-pigeon.png"),
    cues: {
  ...
  P({ slug: "garland", name: "Garland", sanskrit: "Malasana", group: "Hips", level: "Intermediate", image: img("pose-garland.png"),
    cues: {
  ...
  P({ slug: "mountain", name: "Mountain", sanskrit: "Tadasana", group: "Standing", level: "Beginner", image: img("pose-mountain.png"),
    cues: {
  ...
  P({ slug: "forward-fold", name: "Forward Fold", group: "Standing", level: "Beginner", image: img("pose-forward-fold.png"),
    cues: {
  ...
  P({ slug: "downward-dog", name: "Downward Dog", group: "Standing", level: "Beginner", image: img("pose-downward-dog.png"),
    cues: {
  ...
  P({ slug: "warrior-1", name: "Warrior I", sanskrit: "Virabhadrasana I", group: "Standing", level: "Intermediate", image: img("pose-warrior-1.png"),
    cues: {
  ...
  P({ slug: "warrior-2", name: "Warrior II", group: "Standing", level: "Intermediate", image: img("pose-warrior-2.png"),
    cues: {
  ...
  P({ slug: "triangle", name: "Triangle", group: "Standing", level: "Intermediate", image: img("pose-triangle.png"),
    cues: {
  ...
  P({ slug: "chair", name: "Chair", sanskrit: "Utkatasana", group: "Strength", level: "Beginner", image: img("pose-chair.png"),
    cues: {
  ...
  P({ slug: "tree", name: "Tree", sanskrit: "Vrksasana", group: "Balance", level: "Intermediate", image: img("pose-tree.png"),
    cues: {
  ...
  P({ slug: "half-moon", name: "Half Moon", group: "Balance", level: "Advanced", image: img("pose-half-moon.png"),
    cues: {
  ...
  P({ slug: "cobra", name: "Cobra", group: "Backbends", level: "Beginner", image: img("pose-cobra.png"), floorOnly: true,
    cues: {
  ...
  P({ slug: "bridge", name: "Bridge", group: "Backbends", level: "Beginner", image: img("pose-bridge.png"), floorOnly: true,
    cues: {
  ...
  P({ slug: "camel", name: "Camel", sanskrit: "Ustrasana", group: "Backbends", level: "Advanced", image: img("pose-camel.png"),
    cues: {
  ...
  P({ slug: "seated-forward-fold", name: "Seated Forward Fold", sanskrit: "Paschimottanasana", group: "Forward folds", level: "Beginner", image: img("pose-seated-forward-fold.png"), floorOnly: true,
    cues: {
  ...
  P({ slug: "head-to-knee", name: "Head-to-Knee", sanskrit: "Janu Sirsasana", group: "Forward folds", level: "Beginner", image: img("pose-head-to-knee.png"), floorOnly: true,
    cues: {
  ...
  P({ slug: "wide-leg-fold", name: "Wide-Leg Fold", group: "Forward folds", level: "Beginner", image: img("pose-wide-leg-fold.png"),
    cues: {
  ...
  P({ slug: "reclined-bound-angle", name: "Reclined Bound Angle", group: "Restorative", level: "Beginner", image: img("pose-reclined-bound-angle.png"), floorOnly: true,
    cues: {
  ...
  P({ slug: "knees-to-chest", name: "Knees-to-Chest", group: "Restorative", level: "Beginner", image: img("pose-knees-to-chest.png"), floorOnly: true,
    cues: {
  ...
  P({ slug: "supine-twist", name: "Supine Twist", group: "Restorative", level: "Beginner", image: img("pose-supine-twist.png"), floorOnly: true,
    cues: {
  ...
  P({ slug: "legs-up-wall", name: "Legs-Up-the-Wall", group: "Restorative", level: "Beginner", image: img("pose-legs-up-wall.png"), floorOnly: true,
    cues: {
  ...
  P({ slug: "savasana", name: "Savasana", sanskrit: "Corpse Pose", group: "Restorative", level: "Beginner", image: img("pose-savasana.png"), floorOnly: true,
    cues: {
  ...
  P({ slug: "plank", name: "Plank", group: "Strength", level: "Intermediate", image: img("pose-plank.png"),
    cues: {
  ...
  P({ slug: "boat", name: "Boat", sanskrit: "Navasana", group: "Strength", level: "Intermediate", image: img("pose-boat.png"),
    cues: {
  ...
  P({ slug: "side-plank", name: "Side Plank", group: "Strength", level: "Advanced", image: img("pose-side-plank.png"),
    cues: {
    ...
    <div className="space-y-4 sm:space-y-6 yoga-fade">
      ...
      <header className="grid gap-4 sm:gap-6 lg:grid-cols-[1.1fr_1fr] items-stretch">
        ...
        <div className="relative overflow-hidden rounded-3xl border border-petal/60 shadow-xl shadow-rose/10 min-h-[180px]">
          <img src={img("yoga-hero.png")} alt="Soft pink yoga moment" className="absolute inset-0 h-full w-full object-cover" referrerPolicy="no-referrer" />
