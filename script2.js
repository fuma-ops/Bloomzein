...
code = code.replace(/\/images\/pose-([a-z0-9-]*)\.png/g, "https://api.dicebear.com/8.x/shapes/svg?seed=pose-$1");
fs.writeFileSync(file, code);

const file2 = "./src/pages/app.tools.meals.tsx";
let code2 = fs.readFileSync(file2, "utf8");
code2 = code2.replace(/\/images\/meal-([a-z0-9-]*)\.jpg/g, "https://picsum.photos/seed/meal-$1/800/800");
fs.writeFileSync(file2, code2);

const fileShop = "./src/pages/app.shop.tsx";
let codeShop = fs.readFileSync(fileShop, "utf8");
codeShop = codeShop.replace(/\/images\/shop-([a-z0-9-]*)\.jpg/g, "https://picsum.photos/seed/shop-$1/800/800");
